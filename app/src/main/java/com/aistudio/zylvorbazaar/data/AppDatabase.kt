package com.aistudio.zylvorbazaar.data
...
data class User(
    ...
    val requestedDeliveryMobile: String = "",
    val requestedDeliveryVehicleType: String = "",
    val requestedDeliveryVehicleNumber: String = "",
    val requestedDeliveryEmergencyContact: String = "",
    val requestedDeliveryAddress: String = "",
    val requestedDeliveryAddressLat: Double = 0.0,
    val requestedDeliveryAddressLng: Double = 0.0,
...
data class AppConfig(
    ...
    val languages: List<String> = listOf("English", "EspaÃ±ol", "FranÃ§ais", "Deutsch", "Hindi", "Bengali"),
...
class AppRepository(private val appDao: AppDao) {
    ...
    private fun mapToUser(map: Map<String, Any?>): User {
        return User(
            ...
            requestedDeliveryMobile = map["requestedDeliveryMobile"] as? String ?: "",
            requestedDeliveryVehicleType = map["requestedDeliveryVehicleType"] as? String ?: "",
            requestedDeliveryVehicleNumber = map["requestedDeliveryVehicleNumber"] as? String ?: "",
            requestedDeliveryEmergencyContact = map["requestedDeliveryEmergencyContact"] as? String ?: "",
            requestedDeliveryAddress = map["requestedDeliveryAddress"] as? String ?: "",
            requestedDeliveryAddressLat = (map["requestedDeliveryAddressLat"] as? Number)?.toDouble() ?: 0.0,
            requestedDeliveryAddressLng = (map["requestedDeliveryAddressLng"] as? Number)?.toDouble() ?: 0.0,
            ...
            sellerVideoUrl = map["sellerVideoUrl"] as? String ?: "",
    ...
    private fun userToMap(user: User): Map<String, Any> {
        return mapOf(
            ...
            "requestedDeliveryMobile" to user.requestedDeliveryMobile,
            "requestedDeliveryVehicleType" to user.requestedDeliveryVehicleType,
            "requestedDeliveryVehicleNumber" to user.requestedDeliveryVehicleNumber,
            "requestedDeliveryEmergencyContact" to user.requestedDeliveryEmergencyContact,
            "requestedDeliveryAddress" to user.requestedDeliveryAddress,
            "requestedDeliveryAddressLat" to user.requestedDeliveryAddressLat,
            "requestedDeliveryAddressLng" to user.requestedDeliveryAddressLng,
            ...
            "sellerVideoUrl" to user.sellerVideoUrl,
    ...
    fun getAllUsers(): Flow<List<User>> = callbackFlow {
        val listener = FirebaseFirestore.getInstance()
            ...
            .addSnapshotListener { snapshot, error ->
                if (error != null) {
                    // Do NOT close the flow â€” permission-denied or network errors
            ...
            .addSnapshotListener { snapshot, error ->
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    val config = AppConfig(
                        ...
                        languages = (data["languages"] as? List<String>) ?: listOf("English", "EspaÃ±ol", "FranÃ§ais", "Deutsch", "Hindi", "Bengali"),
        ...
        try {
            ...
            if (!doc.exists()) {
                val config = mapOf(
                    ...
                    "languages" to listOf("English", "EspaÃ±ol", "FranÃ§ais", "Deutsch", "Hindi", "Bengali"),
